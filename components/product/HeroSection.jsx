...
useEffect(() => {
  ...
  return (
    <>
    <section className="relative overflow-hidden bg-linear-to-br from-teal-50 via-white to-purple-50 pt-32 pb-20">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.div
              ...
              className="absolute -top-4 -right-4 bg-white rounded-lg shadow-xl p-3 border border-gray-200"
            >
            ...
            <motion.div
              ...
              className="absolute -bottom-4 -left-4 bg-white rounded-lg shadow-xl p-3 border border-gray-200"
            >
              <div className="flex items-center gap-2">
