...
export function QueryPopup({ isOpen, onClose }) {
  ...
  return (
    <>
      ...
      >
        <div
          className="relative w-full max-w-6xl max-h-[90vh] flex flex-col rounded-3xl shadow-2xl animate-in zoom-in-95 duration-300 overflow-hidden"
        ...
        >
          ...
          <div className="sticky top-0 z-10 px-6 md:px-8 pt-6 md:pt-8 pb-6" style={{ backgroundColor: modalBgColor }}>
            <div className="max-w-3xl mx-auto">
              ...
              <div
                className={`relative bg-white rounded-xl shadow-lg border transition-all duration-500 ${currentData ? currentData.borderColor : "border-gray-300"
                  }`}
              >
              ...
              <div key={currentData.id} className="pt-16 pb-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="max-w-5xl mx-auto">
                  <div className="relative w-full">
                    <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[80%] h-full bg-white/20 rounded-2xl shadow-sm -translate-y-9 pointer-events-none z-0" />
                    <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[87%] h-full bg-white/35 rounded-2xl shadow-md -translate-y-6 pointer-events-none z-[1]" />
                    <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[93%] h-full bg-white/50 rounded-2xl shadow-lg -translate-y-3 pointer-events-none z-[2]" />

                    <div
                      className="relative rounded-2xl overflow-hidden shadow-2xl bg-white w-full z-[3]"
