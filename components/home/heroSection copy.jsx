...
export function HeroSection() {
  ...
  return (
    <section className="relative flex-col md:pt-38 pb-8 pt-28 md:min-h- screen flex items-center justify-center overflow-hidden bg[rgba(0,108,93,0.05)] from-gray-50 via-white to-teal-50/30">
