...
// const faqs = [ 
//     {
//         question: "Can I use my existing WhatsApp number with WeoneAi?",
//         answer: "Yes, you can use your existing WhatsApp number. We will help in upgrading your account to WhatsApp Business API so that you can start automating your messages. If you already have a WhatsApp Business API number, we will help you migrate too."
//     },
//     {
//         question: "Is there a limit on number of messages I can send?",
//         answer: "Yes, your account starts with a limit 1000/messages per day. If you consume at least 50% of the limit regularly then within a week your limit is upgraded to 10,000 and then 1L messages/day."
//     },
//     {
//         question: "Can my team members login from multiple devices?",
//         answer: "Yes, multiple members can access QuickReply panel from multiple devices and send/receive messages."
//     },
//     {
//         question: "How much time does it take to setup everything?",
//         answer: "It will take 1-2 days to get your account ready to run promotional campaigns. If requires your Facebook business manager verified. If it is not, it will take another 2-3 days to get it verified."
//     },
...
//                 <div className='mb-10 text-center'>
//                     <div className='text-3xl text-gray-700 md:text-4xl font-bold'>Frequently Asked Questions</div>
//                     <div className='text-xl text-gray-600 mt-2'>Quick answers to our most asked questions</div>
//                 </div>
...
//                                 aria-expanded={openIndex === index}
//                             >
//                                 <h3 className={`font-medium text-lg ${openIndex === index ? 'text-blue-700' : 'text-gray-800'
//                                     }`}>
//                                     {faq.question}
//                                 </h3>
//                                 <div className={`flex-shrink-0 ml-4 p-1 rounded-full ${openIndex === index
